        ...
        <div className="card">
          <div className="additional">
            ...
            <div className="more-info">
              ...
              <div className="coords">
                <span>
                  Phone Number: <label id="phone"></label>
                </span>
              </div>
              <div className="coords">
                <span>
              ...
              <div className="coords">
                <span>
                  Appointment: <label id="appointmentType"></label>
                </span>
              </div>
            </div>
          </div>
          <div className="general">
            ...
            <p>
              {" "}
              Current Time: <label id="currentTime"></label>
            </p>
            <p>
              {" "}
              Time Passed: <label id="difference"></label>
            </p>
